...
namespace
{
    const char* const WINDOW_TITLE = "Assignment 5-3"; // Macro for window title
...
int main(int argc, char* argv[])
{
    ...
    // Load texture
    const char* texFilename = "bricks.jpg"; // Bricks.jpg sourced from https://www.3dmd.net/gallery/displayimage-137.html
