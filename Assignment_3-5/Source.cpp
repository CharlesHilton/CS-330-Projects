...
namespace
{
    const char* const WINDOW_TITLE = "Hilton - Assignment 3-5"; // Macro for window title
    ...
    //    GLuint vbos[2];     // Handles for the vertex buffer objects
    //    GLuint nIndices;    // Number of indices of the mesh
    //    GLuint vertices;    // Hangles of vertices array.
    //    GLushort indices[]; //  Array of indicies to draw triangles.
    //};
...
void URender()
{
    ...
    glm::mat4 rotation = glm::rotate(5.0f, glm::vec3(1.0, 1.0f, 1.0f));
